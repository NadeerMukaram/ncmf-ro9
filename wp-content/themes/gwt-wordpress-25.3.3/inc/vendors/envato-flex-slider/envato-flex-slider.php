...
function efs_get_slider(){
    ...
    if (have_posts()) : 	
        ...
        rewind_posts(); // reset internal loop pointer
        ...
        while (have_posts()) : the_post();
            ...
            $slider .= '<li class="orbit-slide'.($x == 1 ? ' is-active' : '').'">
                            <div class="orbit-slide-number"><span>'.$x.'</span> of <span>'.$count.'</span></div>
                            <a href="'.$slide_link.'">'.$img.'</a>
