...
function govph_displayoptions( $options ){
  ...
  switch ($options) {
    ...
    case 'govph_disable_search':
      return (isset($option['govph_disable_search']) && $option['govph_disable_search'] ? true : false);
      break;
    ...
    case 'govph_banner_title_start':
      ...
      elseif (isset($option['govph_slider_fullwidth']) && $option['govph_slider_fullwidth'] != 'true') {
        echo '';
      }
      break;
